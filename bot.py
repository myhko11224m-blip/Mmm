...
/تحليل — جلب أحدث بيانات السوق وتحليلها
/help — عرض هذه المساعدة
                    """)
                elif text == "/تحليل":
                    try:
                        result = تحليل_السوق("XAUUSD", 1000, "متوازن")
                        msg_text = f"""
...
🧠 ثقة الذكاء الاصطناعي: {result['التحليل']['نسبة_ثقة_الذكاء_الاصطناعي']}

🎯 الإشارة: <b>{result['النتيجة_النهائية']['الاشارة']}</b>
🔒 وقف الخسارة: {result['وقف_الخسارة']['السعر']}
🎯 الهدف الأول: {result['الأهداف']['الهدف_الأول']['السعر']}
🎯 الهدف الثاني: {result['الأهداف']['الهدف_الثاني']['السعر']}
🎯 الهدف الثالث: {result['الأهداف']['الهدف_الثالث']['السعر']}

📊 نسبة الربح/الخسارة: {result['نسبة_الربح_إلى_الخسارة']}
                        """
...
@app.get("/api")
def api_home():
    return {"المنصة": "نبر وان", "الإصدار": "1.2.0 (بيانات حقيقية + تليجرام)", "الحالة": "تعمل", "الواجهة": "/"}
...
<div class="footer">🤖 نبر وان — منصة التداول بالذكاء الاصطناعي<br>الإصدار 1.2.0 — بيانات حقيقية من Binance · تحليل فني حقيقي + بوت تليجرام</div>
</div>
<script>
...
# ============================================================
# ▶️ تشغيل البرنامج — مع تشغيل بوت التليجرام
# ============================================================

if __name__ == "__main__":
    logging.basicConfig(level=logging.INFO)
    start_telegram_bot()  # تشغيل بوت تليجرام في الخلفية
