# ============================================================
# 🤖 نبر وان v1.2 — نسخة مصححة بالكامل
# ✅ بيانات حقيقية من Binance · تم إصلاح خطأ الرمز
# ✅ واجهة ويب كاملة · لا تليجرام
# ============================================================
...
# ✅ رموز Binance الصحيحة والمختبرة
رموز_Binance = {
...
# ============================================================
# 💰 جلب بيانات السوق — مُصحح 100%
# ============================================================

def جلب_شموع_السعر(الزوج):
    """جلب بيانات حقيقية من Binance — تم إصلاح تمرير المعاملات"""
    ...
    try:
        ...
        print(f"⚠️ خطأ جلب البيانات: {e} — استخدام بيانات محاكاة آمنة")
...
@app.get("/api")
def api_home():
    return {"المنصة": "نبر وان", "الإصدار": "1.2.1 (بيانات حقيقية)", "الحالة": "تعمل", "الواجهة": "/"}
...
.result{margin-top:15px;white-space:pre-wrap;background:#01070e;border:1px solid #123c54;border-radius:10px;padding:15px;display:none;color:#fff;}
...
<div class="header">
    <div class="logo">
        <div><div class="logo-title">🤖 نـبـر وان</div><div class="logo-sub">منصة التداول بالذكاء الاصطناعي — بيانات حقيقية من Binance</div></div>
...
<div class="footer">🤖 نبر وان — منصة التداول بالذكاء الاصطناعي<br>الإصدار 1.2.1 — بيانات حقيقية من Binance · تحليل فني حقيقي</div>
</div>
<script>
